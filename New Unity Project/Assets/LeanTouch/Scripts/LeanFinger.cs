	...
	public class LeanFinger
	{
		...
		public Vector3 GetWorldPosition(float distance, Camera camera = null)
		{
			if (LeanTouch.GetCamera(ref camera) == true)
			{
				...
				//ScreenPosition.y=1360;
				//ScreenPosition.y=Camera.main.gameObject.transform.position.y;
				var point = new Vector3(ScreenPosition.x, ScreenPosition.y, distance);
		...
		public GameObject spawnslide (GameObject prefab, Vector3 poss){
			
				//Noteline = GameObject.Find ("Judgeline");
				//ScreenPosition.y = 300;
				//ScreenPosition.y=1360;
				//ScreenPosition.y=Camera.main.gameObject.transform.position.y;
				//var point = new Vector3(ScreenPosition.x, ScreenPosition.y, distance);
